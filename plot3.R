## This function displays plot3 on a new screen graphical device as well as saves
...
plot3 <- function(filename){
	...
	## named "plot3.png" with a width and height of 480 pixels
...
plotGraphs <- function(data,n){
	...
	with(data, plot(datesToTime, Sub_metering_1, xaxt='n',type="l",xlab="",ylab ="Energy sub metering"))
